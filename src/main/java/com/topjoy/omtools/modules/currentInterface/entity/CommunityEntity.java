...
public class CommunityEntity {
    ...
    public CommunityEntity(String id, int gameId, int platformId, int channelId, int childChannelId, int serviceWorkerId, String inputText, String openId, String UID, String account, int service, String roleName, int vipRange, int diamonds, int goldCoin, Integer accountStatus, Integer anExcuseStatus, String source, String lastLoginTime, String registerTime) {
        super();
        this.id = id;
        this.gameId = gameId;
